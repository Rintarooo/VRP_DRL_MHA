...
class AgentVRP():
	...
	def think_capacity(self, next_node, visited_mask):
		...
		D = self.VEHICLE_CAPACITY - self.used_capacity# D denotes "remaining vehicle capacity"
		# D: (batch, 1)
		# D[:,:,None]: (batch, 1, 1)
		...
		mask = mask_capacity | tf.cast(self.visited_nodes, dtype = tf.bool)
		...
		# if there's any False on the specified axis, return False
		# if all customer nodes gives True, mask_depot should return False 
		# mask_depot: (batch, 1)
